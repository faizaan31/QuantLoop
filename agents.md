# QuantLoop - Agent Guidelines

This repository contains QuantLoop, a hybrid backtesting engine combining vectorized preprocessing (Polars) with event-driven execution for trading strategies. Follow these guidelines when working with the codebase.

"""Portfolio: cash, positions, orders, and trade execution."""
...
from quantloop.commissions import CommissionModel, make_commission_model
from quantloop.core.data_utils import extract_date
from quantloop.orders import Order, OrderStatus, OrderType
from quantloop.results import TradeStats
from quantloop.slippage import SlippageModel, make_slippage_model
from quantloop.trades import TradeTracker
...
class Portfolio:
    ...
    def _update_risk_limits(self) -> None:
        ...
        if self.daily_loss_limit is not None:
            current_date = extract_date(self._current_timestamp) if self._current_timestamp is not None else None
    ...
    def _check_order_expiry(self) -> None:
        ...
        if not self._active_order_ids:
            return
        current_date = extract_date(self._current_timestamp)
    ...
    def order_with_sizer(
        ...
        **kwargs: Any,
        ...
        """
        from quantloop.sizers import Sizer as SizerClass
    ...
    def order_day(
        ...
        elif (current_date := extract_date(self._current_timestamp)) is not None:

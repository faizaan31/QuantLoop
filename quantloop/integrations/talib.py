"""Optional TA-Lib integration for QuantLoop.
...
# ---------------------------------------------------------------------------
# Convenience wrappers — mirror the quantloop.indicators API
# ---------------------------------------------------------------------------
...
class TALibIndicators:
    ...
    .. note::
       ...
       ``quantloop.indicators`` returns tuples.  Single-output functions

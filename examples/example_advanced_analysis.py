...
from quantloop.plotting import plot_backtest, plot_param_heatmap, plot_permutation_test, plot_sensitivity

# Try TA-Lib; fall back to built-in indicators if not installed.
try:
    from quantloop.integrations.talib import ta, talib_available
